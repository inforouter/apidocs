...
- [RemoveDocumentCutoffDate](RemoveDocumentCutoffDate) - Remove the cutoff date from a document (required before changing an existing cutoff date)
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/SetDocumentCutoffDate*
