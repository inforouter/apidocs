...
- [GetAllUsers2](GetAllUsers2) - Same filters with full user detail
- [GetAllUsers1](GetAllUsers1) - Paged list without user type filter
- [GetAllUsers](GetAllUsers) - All users without pagination
- [GetUser](GetUser) - Full properties of a specific user
