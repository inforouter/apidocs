...
- [AuthenticateUser](AuthenticateUser) - Standard login returning a new ticket and full profile info
- [AuthenticateUser1](AuthenticateUser1) - Login with explicit session language
- [isValidTicket](isValidTicket) - Check ticket validity without supplying credentials
- [LogOut](LogOut) - Explicitly invalidate a ticket
