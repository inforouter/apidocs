...
- [Lock](Lock) - Lock (check out) the document at the specified path
- [UnLock](UnLock) - Unlock (check in) a locked document
- [GetCheckedoutDocuments](GetCheckedoutDocuments) - Get the list of documents currently checked out by the current user
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/IsLockPossible*
