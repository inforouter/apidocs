...
- [PublishDocument](PublishDocument) - Publish a specific version of a document
- [UnpublishDocument](UnpublishDocument) - Set a document as unpublished
- [GetDocument](GetDocument) - Get document properties including `DocTypeID` and `PublishingRule`
- [UpdateDocumentType](UpdateDocumentType) - Assign a document type to a document
- [GetDomainPolicies](GetDomainPolicies) - Get the full set of policies for a domain/library
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/GetPublishingRequirements*
