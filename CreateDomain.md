...
- [DeleteDomain](DeleteDomain) - Delete a domain/library
- [UpdateDomain](UpdateDomain) - Update domain properties (name, visibility, welcome message)
- [DomainExists](DomainExists) - Check if a domain exists
- [AddUserAsDomainMember](AddUserAsDomainMember) - Add a user to the new domain
- [GetDomain](GetDomain) - Get domain properties
