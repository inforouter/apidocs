...
- [FolderExists](FolderExists) - Check folder existence using a full path
- [GetFolder](GetFolder) - Retrieve folder properties
- [CreateFolder1](CreateFolder1) - Create a subfolder with parent path and name as separate parameters
