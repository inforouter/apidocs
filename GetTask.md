...
- Task IDs are available from [getTasks](getTasks) and [GetDueTaskDocuments](GetDueTaskDocuments).
...
- [getTasks](getTasks) – Get a filtered list of task IDs and summaries.
- [GetDueTaskDocuments](GetDueTaskDocuments) – Get documents with due tasks for the current user.
- [CompleteTask](CompleteTask) – Mark a task as completed.
- [DeleteTask](DeleteTask) – Delete a task.
- [ReassignTask](ReassignTask) – Reassign a task to another user.
