...
- [AuthenticateUser](AuthenticateUser) - Obtain a new authentication ticket
- [RenewTicket](RenewTicket) - Validate credentials and renew a ticket, resetting the expiration
