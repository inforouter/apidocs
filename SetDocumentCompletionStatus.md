...
- [GetDocument](GetDocument) - Get document properties including the current `PercentComplete` and `CompletionDate`
- [Lock](Lock) - Check out a document (a checked-out document cannot be marked complete)
