...
- [Copy](Copy) - Copy a document or folder to another location (creates a full copy, not a shortcut)
- [AddToFavorites](AddToFavorites) - Add a document to the current user's favorites list
- [GetDocument](GetDocument) - Retrieve properties of a document (works on both shortcuts and regular documents)
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/CreateDocumentShortcut*
