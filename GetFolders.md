...
- [GetFolders1](GetFolders1) - Get subfolders in short form (name and ID only)
- [GetFolders2](GetFolders2) - Get subfolders with UI display count limit
- [GetFoldersByPage](GetFoldersByPage) - Get paged subfolders with filter
- [GetFolder](GetFolder) - Get properties of a single folder
- [GetFoldersAndDocuments](GetFoldersAndDocuments) - Get both folders and documents
