...
- [ForgotPassword](ForgotPassword) - Initiate password reset by the user's registered email address
- [ChangePasswordUsingSecretText](ChangePasswordUsingSecretText) - Complete the reset by submitting the token and new password
