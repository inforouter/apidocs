...
- [GetDocument](GetDocument) - Get document properties including the current classification level and dates
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/SetClassificationLevel*
