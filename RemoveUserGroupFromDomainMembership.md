...
- [AddUserGroupAsDomainMember](AddUserGroupAsDomainMember) - Add a user group to a domain
- [GetDomainMembers](GetDomainMembers) - List all member groups and users of a domain
- [DeleteUsergroup](DeleteUsergroup) - Permanently delete a user group
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/RemoveUserGroupFromDomainMembership*
