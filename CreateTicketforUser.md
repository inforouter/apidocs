...
- [AuthenticateUser](AuthenticateUser) - Standard username/password login returning full profile info
- [AuthenticateUser1](AuthenticateUser1) - Standard login with explicit session language
- [GetCurrentUser](GetCurrentUser) - Retrieve profile information of the currently authenticated user
