...
- [GetDownloadInfo](GetDownloadInfo) - Get download metadata for the latest version of a document
- [GetDocumentVersions](GetDocumentVersions) - Get the version list to obtain valid VersionNumber values
- [GetDownloadHandlerByVersion](GetDownloadHandlerByVersion) - Stage a specific version and return a handler GUID for chunked download
- [DownloadDocumentVersion](DownloadDocumentVersion) - Download a specific version as a raw byte array in a single call
