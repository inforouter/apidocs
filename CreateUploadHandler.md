...
- [UploadFileChunk](UploadFileChunk) - Upload a single chunk of a file to an open handler
- [UploadDocumentWithHandler](UploadDocumentWithHandler) - Finalize the upload and create or update a document
- [DeleteUploadHandler](DeleteUploadHandler) - Delete an upload handler and discard its staged data
- [UploadDocument](UploadDocument) - Upload a complete document in a single call (no handler required)
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/CreateUploadHandler*
