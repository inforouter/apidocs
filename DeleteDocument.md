...
- [RestoreRecycleBinItem](RestoreRecycleBinItem) - Restore a document from the recycle bin
- [PurgeRecycleBinItem](PurgeRecycleBinItem) - Permanently delete a document from the recycle bin
- [EmptyRecycleBin](EmptyRecycleBin) - Permanently delete all items in the current user's recycle bin
- [GetRecycleBinContent](GetRecycleBinContent) - List documents currently in the recycle bin
- [DeleteFolder](DeleteFolder) - Move a folder to the recycle bin
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/DeleteDocument*
