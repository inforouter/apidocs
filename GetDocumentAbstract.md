...
> **OBSOLETE** — This API is retained for backward compatibility only. Use [`GetDocumentAbstract1`](GetDocumentAbstract1) for new integrations. `GetDocumentAbstract1` returns a consistent XML structure for both success and error cases; this API does not.
...
> **Warning:** The success and error responses use different XML structures — this inconsistency is the primary reason this API is considered obsolete. See [`GetDocumentAbstract1`](GetDocumentAbstract1) for a consistent response format.
...
- This API is **obsolete**. Use [`GetDocumentAbstract1`](GetDocumentAbstract1) for all new integrations.
...
- [GetDocumentAbstract1](GetDocumentAbstract1) - Preferred replacement with consistent XML response structure
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/GetDocumentAbstract*
