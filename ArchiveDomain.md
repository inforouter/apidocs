...
- [UnarchiveDomain](UnarchiveDomain) - Un-archive a domain/library to make it active again
- [GetDomain](GetDomain) - Get properties of a domain/library including archive status
- [GetDomains](GetDomains) - Get list of all domains/libraries with their archive status
- [UpdateDomain](UpdateDomain) - Update other domain properties
- [GetMemberDomains](GetMemberDomains) - Get list of member domains (excludes archived by default)
