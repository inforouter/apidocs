...
- [ChangePasswordUsingSecretText](ChangePasswordUsingSecretText) - Reset password using a one-time email token (no ticket required)
- [ForgotPassword](ForgotPassword) - Initiate a password reset by email address
- [ForgotPasswordByUserName](ForgotPasswordByUserName) - Initiate a password reset by user name
- [GetAuthenticationAndPasswordPolicy](GetAuthenticationAndPasswordPolicy) - Retrieve the current password complexity policy
