...
- [UnpublishDocument](UnpublishDocument) - Remove the published status from a document
- [GetPublishingRequirements](GetPublishingRequirements) - Get the publishing requirements configured for a domain/library
- [GetDocumentVersions](GetDocumentVersions) - Get the version history list to obtain internal version numbers
- [GetDocument](GetDocument) - Get document properties including `PublishingRule`, `PublishedVersionNumber`, and `DocTypeID`
- [UpdateDocumentType](UpdateDocumentType) - Assign a document type to satisfy a Doctype publishing requirement
