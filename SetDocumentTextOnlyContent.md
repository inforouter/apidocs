...
- [SetVersionTextOnlyContent](SetVersionTextOnlyContent) - Update text-only content for a specific document version
- [GetDocumentTextOnlyContent](GetDocumentTextOnlyContent) - Retrieve the stored text-only content of the latest version
