...
- [Lock](Lock) - Lock (check out) a document or all documents in a folder
- [GetCheckedoutDocuments](GetCheckedoutDocuments) - Get the list of documents currently checked out by the authenticated user
- [IsLockPossible](IsLockPossible) - Check whether a document can be locked
