...
- [CreateFlowDef](CreateFlowDef) – Minimal variant without `OnEndMoveToPath`.
- [CreateFlowDef2](CreateFlowDef2) – Adds a `Supervisor` parameter.
- [CreateFlowDef3](CreateFlowDef3) – Full variant with all options.
