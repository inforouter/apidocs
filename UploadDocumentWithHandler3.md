...
- [UploadDocumentWithHandler](UploadDocumentWithHandler) - Basic handler finalization
...
- [UploadDocument4](UploadDocument4) - Direct byte-array upload with the same XML parameters
