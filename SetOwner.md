...
- [GetOwner](GetOwner) - Retrieve the current owner of a document or folder
- [TransferUserDocumentOwnerships](TransferUserDocumentOwnerships) - Bulk-transfer document ownership from one user to another
- [TransferUserFolderOwnerships](TransferUserFolderOwnerships) - Bulk-transfer folder ownership from one user to another
- [GetAccessList](GetAccessList) - Retrieve the access list for a document or folder
