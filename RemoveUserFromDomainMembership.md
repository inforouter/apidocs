...
- [AddUserAsDomainMember](AddUserAsDomainMember) - Add a user to the domain membership
- [RemoveManagerFromDomain](RemoveManagerFromDomain) - Remove manager status only (keep membership)
- [GetDomainMembers](GetDomainMembers) - Get all members of the domain
- [GetDomainMembershipsOfUser](GetDomainMembershipsOfUser) - Get all domain memberships of a user
