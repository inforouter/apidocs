...
- [DeleteUser1](DeleteUser1) - Delete a user with administrator password confirmation
- [UserExists](UserExists) - Check if a user exists before attempting deletion
- [TransferUserDocumentOwnerships](TransferUserDocumentOwnerships) - Transfer document ownerships before deletion
- [TransferUserTasks](TransferUserTasks) - Transfer workflow tasks before deletion
- [ChangeUserStatus](ChangeUserStatus) - Disable a user account without deleting it
