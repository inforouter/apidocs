...
- [DocumentExists](DocumentExists) - Check document existence using a single combined path (also supports short `~D` paths)
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/DocumentExists1*
