...
- [UploadTiffAsPDFWithHandler](UploadTiffAsPDFWithHandler) - Upload TIFF as PDF using a chunked upload handler
- [UploadDocument](UploadDocument) - Upload any document in its original format
