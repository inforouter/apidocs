...
- To check which users are redirecting tasks *to* a given user, use [GetUserTaskRedirectionsFrom](GetUserTaskRedirectionsFrom).
...
- [GetUserTaskRedirectionsFrom](GetUserTaskRedirectionsFrom) – List all users who are redirecting their tasks to a given user.
