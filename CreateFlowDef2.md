...
- [CreateFlowDef](CreateFlowDef) – Minimal variant.
- [CreateFlowDef1](CreateFlowDef1) – Adds `OnEndMoveToPath` only.
- [CreateFlowDef3](CreateFlowDef3) – Full variant with all options including event URL and hidden flag.
- [AddFlowStepDef](AddFlowStepDef) – Add steps after creation.
- [ActivateFlowDef](ActivateFlowDef) – Activate the workflow definition.
