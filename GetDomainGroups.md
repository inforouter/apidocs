...
- [GetLocalGroups](GetLocalGroups) - Get only local groups of a domain
- [GetGlobalGroups](GetGlobalGroups) - Get all global user groups in the system
- [AddUserGroupAsDomainMember](AddUserGroupAsDomainMember) - Add a global group as a domain member
