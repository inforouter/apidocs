...
- [CreateDomain](CreateDomain) - Create a new domain/library
- [ArchiveDomain](ArchiveDomain) - Archive (deactivate) a domain without deleting it
- [DomainExists](DomainExists) - Check if a domain exists before deleting
- [GetDomains](GetDomains) - List all domains
