...
- [GetDocument](GetDocument) - Get document properties (includes `DocTypeID` and `DocTypeName`)
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/GetDocumentTypes*
