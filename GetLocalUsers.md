...
- [GetDomainUsers](GetDomainUsers) - Get all users in a domain including indirect members
- [GetDomainMembers](GetDomainMembers) - Get users and user groups that are members of a domain
- [AddUserAsDomainMember](AddUserAsDomainMember) - Add a user to a domain as a direct member
