...
- [RegisterEmail](RegisterEmail) - Register an email using a combined `TargetPath` (no keywords, no MessageId)
- [RegisterEmail1](RegisterEmail1) - Register an email using a combined `TargetPath` with keywords
- [RegisterEmail2](RegisterEmail2) - Register an email using separate `FolderPath` and `EmailName` with individual field parameters
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/RegisterEmail3*
