...
- [GetFolderStatistics](GetFolderStatistics) - Get comprehensive folder statistics
- [GetFolders](GetFolders) - Get the list of subfolders
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/GetSubFoldersCount*
