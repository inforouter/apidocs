...
- [AuthenticateUser1](AuthenticateUser1) - Authenticate and specify a session language
- [AuthenticateUserViaWindows](AuthenticateUserViaWindows) - Authenticate using Windows (NTLM/Kerberos) credentials
- [CreateTicketforUser](CreateTicketforUser) - Create a ticket for a user via server-to-server trusted password
