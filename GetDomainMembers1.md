...
- [GetDomainMembers](GetDomainMembers) - Simplified version with no sort or detail control
- [GetDomainUsers1](GetDomainUsers1) - Get all users (including indirect via groups) with sort control
- [AddUserAsDomainMember](AddUserAsDomainMember) - Add a user to the domain
- [GetManagers](GetManagers) - Get the list of domain managers
