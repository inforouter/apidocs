...
- To list all workflows for a domain without step detail, use [GetDomainFlows](GetDomainFlows).
- To list workflows active on a specific folder, use [GetFolderFlows](GetFolderFlows).

## Related APIs

- [GetDomainFlows](GetDomainFlows) – List all workflow definitions for a domain (without step detail).
- [GetFolderFlows](GetFolderFlows) – List workflow definitions active on a specific folder.
...
- [DeactivateFlowDef](DeactivateFlowDef) – Deactivate a workflow definition to allow changes.
- [AddFlowStepDef](AddFlowStepDef) – Add a step to a workflow definition.
