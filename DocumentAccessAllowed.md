...
- [FolderAccessAllowed](FolderAccessAllowed) - Check whether an action is allowed on a folder
- [GetAccessList](GetAccessList) - Retrieve the full access list for a document
- [SetAccessList](SetAccessList) - Set the access list for a document
