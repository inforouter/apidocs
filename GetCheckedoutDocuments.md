...
- [GetCheckedoutDocumentsByUser](GetCheckedoutDocumentsByUser) - Get checked-out documents for a specified user (requires elevated permissions)
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/GetCheckedoutDocuments*
