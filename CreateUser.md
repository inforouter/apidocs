...
- [UserExists](UserExists) - Check if a username already exists before creating
- [DeleteUser](DeleteUser) - Delete a user account
- [UpdateUserProfile](UpdateUserProfile) - Update user profile after creation
- [AddUserAsDomainMember](AddUserAsDomainMember) - Add an existing user to a domain/library
