...
- [RemoveUserFromDomainMembership](RemoveUserFromDomainMembership) - Remove a user from domain membership
- [AddUserGroupAsDomainMember](AddUserGroupAsDomainMember) - Add a user group as domain member
- [GetDomainMembers](GetDomainMembers) - Get all members of the domain
- [AddManagerToDomain](AddManagerToDomain) - Designate a member as a domain manager
