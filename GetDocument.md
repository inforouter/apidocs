...
- [GetFoldersAndDocuments](GetFoldersAndDocuments) - List documents and sub-folders within a folder path
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/GetDocument*
