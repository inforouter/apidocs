...
- [UnLock](UnLock) - Release a lock (check in) on a document or all documents in a folder
- [IsLockPossible](IsLockPossible) - Check whether the current user can lock a document before attempting
- [GetCheckedoutDocuments](GetCheckedoutDocuments) - Get the list of documents currently locked by the current user
- [GetDocument](GetDocument) - Get document properties including `CheckoutBy` and `CheckoutDate`
- [UploadDocument](UploadDocument) - Upload a new version of a locked document
