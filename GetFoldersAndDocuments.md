...
- [GetFoldersAndDocuments1](GetFoldersAndDocuments1) - Returns the same contents in short form (name, path, and ID only)
- [GetFoldersAndDocumentsByPage](GetFoldersAndDocumentsByPage) - Returns the first page (up to 20 items) of folder contents
- [GetFoldersAndDocumentsByPage2](GetFoldersAndDocumentsByPage2) - Returns folder contents page by page in enhanced form
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/GetFoldersAndDocuments*
