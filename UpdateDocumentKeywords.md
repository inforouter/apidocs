...
- [GetDocumentKeywords](GetDocumentKeywords) - Retrieve the current keywords of a document
- [GetDocument](GetDocument) - Get all document properties including keywords
- [UpdateDocumentProperties](UpdateDocumentProperties) - Update document name, description, and update instructions
