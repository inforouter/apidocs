...
- [GetFavorites](GetFavorites) - Get the current user's favorite items
- [GetCheckedoutDocuments](GetCheckedoutDocuments) - Get documents checked out by the current user
- [GetRecentDocuments](GetRecentDocuments) - Get recently accessed documents
