...
- [AddManagerToDomain](AddManagerToDomain) - Designate a user as a domain manager
- [RemoveUserFromDomainMembership](RemoveUserFromDomainMembership) - Remove a user from the domain entirely
