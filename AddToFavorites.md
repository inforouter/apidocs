...
- [RemoveFromFavorites](RemoveFromFavorites) - Remove a document or folder from the current user's favorites
- [GetFavorites](GetFavorites) - Retrieve the current user's favorites list
