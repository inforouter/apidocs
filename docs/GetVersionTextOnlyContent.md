...
- [SetVersionTextOnlyContent](SetVersionTextOnlyContent.md) - Set the text-only content for a specific version
- [GetDocumentVersions](GetDocumentVersions.md) - Get the version history list for a document (to obtain internal version numbers)
