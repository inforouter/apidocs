...
- [GetRecentDocuments](GetRecentDocuments.md) - Returns recently accessed documents for the current user
- [GetFoldersAndDocuments](GetFoldersAndDocuments.md) - Returns folders and documents within a specific folder path
- [DownloadZip](DownloadZip.md) - Download multiple documents and folders as a zip archive
