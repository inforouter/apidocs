...
This is the counterpart to [ActivateFlowDef](ActivateFlowDef.md). The operation is **idempotent**: calling it on an already-inactive workflow returns success immediately without error.
