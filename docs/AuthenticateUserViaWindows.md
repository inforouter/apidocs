...
- [AuthenticateUser](AuthenticateUser.md) - Authenticate with explicit user name and password
- [AuthenticateUser1](AuthenticateUser1.md) - Authenticate with user name, password, and session language
- [RenewTicket](RenewTicket.md) - Renew a ticket using credentials
- [isValidTicket](isValidTicket.md) - Check whether an existing ticket is still valid
