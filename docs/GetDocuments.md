...
- [GetFoldersAndDocuments](GetFoldersAndDocuments.md) - List both sub-folders and documents within a folder path with full detail options
- [GetDocuments1](GetDocuments1.md) - Get the list of documents in a folder in short form
- [GetDocumentsByPage](GetDocumentsByPage.md) - Get a paginated list of documents in a folder
