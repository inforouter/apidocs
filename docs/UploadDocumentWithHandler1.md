...
Commits content staged with [UploadFileChunk](UploadFileChunk.md), adding a version comment.

```javascript
await call('UploadDocumentWithHandler1', {
  authenticationTicket: ticket, Path: '/Finance/Reports/Q1.pdf', UploadHandler: handler,
  VersionComments: 'Corrected after review'
});
```
