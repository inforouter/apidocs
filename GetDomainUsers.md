...
- [GetDomainUsers1](GetDomainUsers1) - Get all domain users with sort and detail-mode control
- [GetDomainMembers](GetDomainMembers) - Get direct members (users and groups separately)
- [GetLocalUsers](GetLocalUsers) - Get only local users of the domain (not global group members)
