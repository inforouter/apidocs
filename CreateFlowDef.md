...
- [CreateFlowDef1](CreateFlowDef1) – Creates a workflow definition with an on-end destination folder.
- [CreateFlowDef2](CreateFlowDef2) – Creates a workflow definition with an on-end folder and a supervisor.
- [CreateFlowDef3](CreateFlowDef3) – Creates a workflow definition with all options including event URL and hidden flag.
- [AddFlowStepDef](AddFlowStepDef) – Add steps to the workflow definition after creation.
...
- [DeactivateFlowDef](DeactivateFlowDef) – Deactivate a workflow to modify its steps.
