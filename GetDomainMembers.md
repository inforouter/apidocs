...
- [GetDomainMembers1](GetDomainMembers1) - Get members with sort and detail-mode control
- [GetDomainUsers](GetDomainUsers) - Get all users including indirect group members
- [AddUserAsDomainMember](AddUserAsDomainMember) - Add a user to the domain
- [AddUserGroupAsDomainMember](AddUserGroupAsDomainMember) - Add a user group to the domain
- [GetManagers](GetManagers) - Get the domain managers list
