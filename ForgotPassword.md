...
- [ForgotPasswordByUserName](ForgotPasswordByUserName) - Initiate password reset using the user's login name instead of email
- [ChangePasswordUsingSecretText](ChangePasswordUsingSecretText) - Complete the reset by submitting the token received by email and a new password
