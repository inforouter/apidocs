...
- [GetDomains](GetDomains) - Get a list of all domains in the system
- [UpdateDomain](UpdateDomain) - Update domain properties
- [GetDomainMembers](GetDomainMembers) - Get the domain's member list
- [GetManagers](GetManagers) - Get the domain's manager list
