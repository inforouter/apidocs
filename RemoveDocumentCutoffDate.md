...
- [SetDocumentCutoffDate](SetDocumentCutoffDate) - Apply a cutoff date to a document
- [RemoveFolderCutoffDate](RemoveFolderCutoffDate) - Remove the cutoff date from a folder (required first if the parent folder is cut off)
- [GetDocument](GetDocument) - Get document properties including the current `CutOffDate`
- [GetDomainPolicies](GetDomainPolicies) - Get retention and disposition policies for a domain/library
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/RemoveDocumentCutoffDate*
