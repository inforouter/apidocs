...
- [GetUser](GetUser) - Get full properties of an existing user
- [CreateUser](CreateUser) - Create a new user
- [DeleteUser](DeleteUser) - Delete an existing user
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/UserExists*
