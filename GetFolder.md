...
- [GetFolders](GetFolders) - Get list of subfolders with full properties
- [GetFolderRules](GetFolderRules) - Get only the rules for a folder
- [UpdateFolderProperties](UpdateFolderProperties) - Update folder name and description
- [SetFolderRules](SetFolderRules) - Set folder rules
