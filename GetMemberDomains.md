...
- [GetDomains](GetDomains) - Get all domains in the system
- [GetDomainMembershipsOfUser](GetDomainMembershipsOfUser) - Get domain memberships for a specific user
- [AddUserAsDomainMember](AddUserAsDomainMember) - Add the user to a domain
- [GetDomain](GetDomain) - Get properties of a specific domain
