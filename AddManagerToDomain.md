...
- [RemoveManagerFromDomain](RemoveManagerFromDomain) - Remove manager status from a user
- [AddUserAsDomainMember](AddUserAsDomainMember) - Add a user as a domain member
- [GetManagers](GetManagers) - Get the list of managers for a domain
- [GetDomainMembers](GetDomainMembers) - Get all members of a domain
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/AddManagerToDomain*
