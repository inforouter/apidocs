...
- [GetUserGroupMembers1](GetUserGroupMembers1) - Members with configurable sort and detail level
- [GetUserGroup](GetUserGroup) - Get user group properties
- [AddUsergroupMember](AddUsergroupMember) - Add a member to a group
- [RemoveUsergroupMember](RemoveUsergroupMember) - Remove a member from a group
