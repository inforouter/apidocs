...
- [SetDocumentTextOnlyContent](SetDocumentTextOnlyContent) - Update text-only content for the latest document version
- [GetVersionTextOnlyContent](GetVersionTextOnlyContent) - Retrieve the stored text-only content of a specific version
- [GetDocumentVersions](GetDocumentVersions) - Retrieve the list of all versions for a document
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/SetVersionTextOnlyContent*
