...
- [GetDomainUsers](GetDomainUsers) - Simplified version with default sort and full detail
- [GetDomainMembers1](GetDomainMembers1) - Get direct members (users and groups separately) with sort control
- [GetLocalUsers](GetLocalUsers) - Get only users local to the domain
- [GetDomainMembers](GetDomainMembers) - Get direct members without sort control
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/GetDomainUsers1*
