...
- [RegisterEmail](RegisterEmail) - Register an email without keywords
- [RegisterEmail2](RegisterEmail2) - Register an email with folder path and document name as separate parameters
...
- [UpdateDocumentKeywords](UpdateDocumentKeywords) - Update keywords on an existing document
