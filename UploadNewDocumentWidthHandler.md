...
- [UploadDocumentWithHandler3](UploadDocumentWithHandler3) - Upload new or versioned document with XML parameters
- [UploadDocument4](UploadDocument4) - Direct upload (non-chunked) with XML parameters
