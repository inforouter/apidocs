...
- [DownloadFileChunk](DownloadFileChunk) - Download chunks of the staged zip archive using the handler GUID
- [DeleteDownloadHandler](DeleteDownloadHandler) - Clean up the download handler after all chunks are retrieved
- [DownloadZip](DownloadZip) - Download a zip of documents and folders as a raw byte array in one call (suitable for small archives)
