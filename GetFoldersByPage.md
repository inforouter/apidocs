...
- [GetFolders](GetFolders) - Get all subfolders with full properties (no paging)
- [GetFolders1](GetFolders1) - Get all subfolders in short form (no paging)
- [GetFoldersAndDocumentsByPage](GetFoldersAndDocumentsByPage) - Paged listing of both folders and documents
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/GetFoldersByPage*
