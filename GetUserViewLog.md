...
- [GetUserViewLog1](GetUserViewLog1) - Get user view log history filtered by date range
- [GetDocumentViewLog](GetDocumentViewLog) - Get the view log for a specific document (all users who accessed it)
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/GetUserViewLog*
