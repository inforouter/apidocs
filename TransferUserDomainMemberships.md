...
- [TransferUserGroupMemberships](TransferUserGroupMemberships) - Transfer user group memberships
- [TransferUserDomainManagerRoles](TransferUserDomainManagerRoles) - Transfer domain manager roles
- [AddUserAsDomainMember](AddUserAsDomainMember) - Add a user to a domain manually
