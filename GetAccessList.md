...
- [GetAccessListHistory](GetAccessListHistory) - Get the current access list plus historical changes
- [SetAccessList](SetAccessList) - Set the access list for a document or folder
- [ApplyInheritedAccessList](ApplyInheritedAccessList) - Revert to inherited security
