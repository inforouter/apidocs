...
- [GetDocumentTextOnlyContent](GetDocumentTextOnlyContent) - Get text-only content of the latest published version (no version number required)
- [SetVersionTextOnlyContent](SetVersionTextOnlyContent) - Set the text-only content for a specific version
- [GetDocumentVersions](GetDocumentVersions) - Get the version history list for a document (to obtain internal version numbers)
- [GetDocumentAbstract1](GetDocumentAbstract1) - Get the full-text search index abstract for a document version
