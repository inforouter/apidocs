...
- [GetFoldersAndDocumentsByPage](GetFoldersAndDocumentsByPage) - Simpler paged listing with text filters
- [GetFoldersAndDocuments2](GetFoldersAndDocuments2) - Ultra-fast listing without paging
- [Search](Search) - Full system-wide search with the same XML filter format
