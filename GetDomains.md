...
- [GetMemberDomains](GetMemberDomains) - Get domains where the current user is a member
- [GetDomain](GetDomain) - Get properties of a single domain
- [DomainExists](DomainExists) - Check if a specific domain exists
- [CreateDomain](CreateDomain) - Create a new domain
- [ArchiveDomain](ArchiveDomain) - Archive a domain
...
*For detailed documentation visit: https://support.inforouter.com/api-docs/GetDomains*
