...
- [RegisterEmail1](RegisterEmail1) - Register an email with user-defined keywords
- [RegisterEmail2](RegisterEmail2) - Register an email with the folder path and document name as separate parameters
