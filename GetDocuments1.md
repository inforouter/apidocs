...
- [GetFoldersAndDocuments1](GetFoldersAndDocuments1) - Return both sub-folders and documents in short form
- [GetDocumentsByPage](GetDocumentsByPage) - Get a paginated list of documents in a folder in short form
